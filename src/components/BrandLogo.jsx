...
export default function BrandLogo({ badge = 'Academy', className = '' }) {
  return (
    <div className={`flex items-center gap-2 group ${className}`}>
      {/* Maintains exact same font ('Poppins', sans-serif), text style, and size */}
      <span className="text-2xl font-bold tracking-tight text-[#181E4B] font-sans flex items-center leading-none">
        Learn<span className="text-[#F1A501] ml-1.5 font-extrabold">Tour Guide</span>
      </span>
      {badge && (
